 ...
 *   post:
 *     description: For add/update an category permission to particular admin
 *     tags:
 *       - Admin API`S
 *     produces:
 *       - application/json
 ...
 *           $ref: '#/definitions/Stock'
 */
app.post('/admin/category/permission',
connection.sequeliz.connect,
Auth.authenticateAccessTokenV1,
Auth.checkforAuthorityofThisAdminV1,
    expressJoi({body: {
                categoryIds:Joi.array().required(),
                adminId:Joi.number().optional().allow("")
        }
    }),
    CatController.permision.assignment
)

/**
 * @swagger
 * /admin/category/permission/list:
 *   get:
 *     description: For listing an permission data of category
 *     tags:
 *       - Admin API`S
 *     consumes:
 *       - application/json
 ...
 *         description: Success!
 */
app.get('/admin/category/permission/list',
connection.sequeliz.connect,
Auth.authenticateAccessTokenV1,
Auth.checkforAuthorityofThisAdminV1,
    expressJoi({body: {
    ...
    CatController.permision.assignmentList
)
