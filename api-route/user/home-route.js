...
/**
 * @swagger
 * /customer_register_step_third:
 *   post:
 *     description: api used for adding an step third
 *     tags:
 *       - App API`S
 *     produces:
 *       - application/json
 ...
 *           $ref: '#/definitions/Stock'
 */
app.post('/customer_register_step_third',
multipartMiddleware,
...
//     {    
//         email:Joi.string().optional().allow(""),
//         id_for_invoice:Joi.string().optional().allow(""),
//         name:Joi.string().optional().allow(""),
//         business_name:Joi.string().optional().allow(""),
//         business_name:Joi.string().optional().allow(""),
//         abn_number:Joi.string().optional().allow(""),
//         accessToken:Joi.string().optional().allow(""),
//         dateOfBirth:Joi.string().optional().allow("")
//     }
// }),
Controller.UserController.registeration.stepThird
),
...
multipartMiddleware,
connection.sequeliz.connect,
Auth.storeDbInRequestV1,
Auth.userAuthenticateV1,
// Auth.checkCblAuthority,
 ...
 * /get_all_offer_listf:
 *   get:
 *     description: api used for getting an offer on product/service
 *     tags:
 *       - App API`S
 *     produces:
 *       - application/json
 ...
 *           $ref: '#/definitions/Stock'
 */
app.get('/get_all_offer_listf',
Auth.checkCblAuthorityV1,
expressJoi({
    query: 
    {  
        longitude : Joi.number().required(),
