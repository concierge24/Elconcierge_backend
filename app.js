...
const genrateMode=require('./sequliezed/genrateModel')
...
require('./api-route/user/posts-route')(app);
require('./api-route/swagger-route')(app)
require('./api-route/variant-route')(app)
require('./api-route/product-route')(app)
require('./api-route/category-route')(app)
require('./api-route/admin/product-route')(app)
require('./api-route/supplier/product-route')(app)
require('./api-route/supplier/agent-route')(app)
require('./api-route/supplier/order-route')(app)
require('./api-route/supplier/subscription-route')(app)
require('./api-route/admin/area-route')(app)
require('./api-route/user/area-route')(app)
require('./api-route/user/rating-route')(app)
require('./api-route/user/agent-route')(app)
require('./api-route/admin/variant-route')(app)
require('./api-route/admin/brand-route')(app)
require('./api-route/admin/agent-route')(app)
require('./api-route/admin/cat-route')(app);
require('./api-route/admin/pgateway-route')(app)
require('./api-route/supplier/cat-route')(app);
require('./api-route/common-route')(app);
require('./api-route/user/order-route')(app);
require('./api-route/user/home-route')(app);
require('./api-route/user/address-route')(app);
require('./api-route/admin/dashboard-route')(app);
require('./api-route/supplier/dashboard-route')(app);
require('./api-route/admin/settings-route')(app);
require('./api-route/supplier/gift-route')(app);
require('./api-route/supplier/variant-route')(app);
require('./api-route/supplier/brand-route')(app);
require('./api-route/admin/banner-route')(app);
require('./api-route/admin/password-route')(app);
require('./api-route/admin/supplier-route')(app);
require('./api-route/admin/gift-route')(app);
require('./api-route/admin/promo-route')(app);
require('./api-route/admin/terminologies-route')(app);
require('./api-route/admin/loyality-route')(app);
require('./api-route/admin/termsConditions-route')(app);
require('./api-route/admin/placeHolder-route')(app);
require('./api-route/admin/login-route')(app);
require('./api-route/admin/order-route')(app);
require('./api-route/admin/subAdmin-route')(app);
require('./api-route/admin/cancellationPolicy-route')(app);
require('./api-route/user/payment-route')(app)
require('./api-route/user/referral_route')(app)
require('./api-route/user/loyality-route')(app)
require('./api-route/supplier/profile-route')(app)

require('./api-route/admin/subscription-route')(app)
require('./api-route/admin/surveymonkey-route')(app);
require('./api-route/user/wallet-route')(app);
require('./api-route/user/promo-route')(app);
require('./api-route/admin/pos-route')(app);
require('./routes/cronJob');
require('./api-route/agent/service-route')(app);
require('./api-route/admin/deliveryCompanies-route')(app);
require('./api-route/delivery_company-route')(app);
require('./api-route/user/login-route')(app);

require('./api-route/admin/countryCodes-route')(app);
require('./api-route/migration/migration-route')(app);
require('./api-route/admin/seqModel-route')(app);
var swagger = require('./api-route/swagger')(app);
...
app.post('/check_otp_new',Auth.checkCblAuthority, Auth.storeDbInRequest, users.checkOtpNew);
