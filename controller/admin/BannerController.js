...
function updateBanner(dbName,banner_id,flow_banner_type,accessToken,sectionId,
    ...
    let params = [isBottom,supplierId,name[0],order,startDate,endDate,activeStatus,categoryId,branch_id,website_image_url,phone_image_url,flow_banner_type,is_video,phone_video,website_video,banner_id]
