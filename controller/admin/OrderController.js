                    ...
                    /************************************************************/
                        ...
                        if(i_quantity < itemOrder_quantity){
                            ...
                            if(table_book_mac_theme && table_book_mac_theme.length>0){
                                ...
                                if(parseFloat(previous_table_book_fee)>parseFloat(curr_table_booking_fee)){
                            ...
                            refundAmount=refundAmount+modifiedOrderPrice;
                            finalNetAmount=parseFloat(itemOrder[0].net_amount)-parseFloat(modifiedOrderPrice)-parseFloat(table_book_fee);
                            ...
                            modifiedOrderPrice=totalQuantity*parseFloat(i.price);
                            remainingAmount=remainingAmount+modifiedOrderPrice;
                            finalNetAmount=parseFloat(itemOrder[0].net_amount)+parseFloat(modifiedOrderPrice)+parseFloat(curr_table_booking_fee);
