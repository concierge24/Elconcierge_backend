...
exports.addCategory = function (req, res) {
    ...
    async.waterfall([
        ...
        function (name, cb) {
            ...
            savecategory(req.dbName,order_instructions,cart_image_upload,res, cb, names[0], imageName, iconName, adminId, supplierPlaceMentLevel,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation,menu_type,is_dine)
...
exports.editSubCategory = function (req, res) {
    ...
    async.waterfall([
        ...
        function (name1,cb) {
            iconName = name1;
            updateCategory(req.dbName,order_instructions,cart_image_upload,res, cb, subCategoryId, names[0], imageName, iconName,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation,menu_type);
        },
        function (cb) {
          //  console.log("======call======createQueryStringForMlSubCat=================");
   ...
   // console.log("==================image===========" + JSON.stringify(image));
    ...
    async.waterfall([
        ...
        function (name1, cb) {
            ...
            iconName = name1;
            updateCategory(req.dbName,order_instructions,cart_image_upload,res, cb, categoryId, names[0], imageName, iconName,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation, menu_type,is_dine);
        },
        function (cb) {
 ...
 *  into category table.
 */
async function savecategory(dbName,order_instructions,cart_image_upload,res, callback, name, imageName, iconName, adminId, supplierPlaceMentLevel,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation,menu_type,is_dine) {
    try{
    var sql = "insert into categories(`order_instructions`,`cart_image_upload`,`name`, `supplier_placement_level`,  `image`, `icon`,`created_by`,`is_variant`,`category_flow`,`agent_list`,`start_time`,`end_time`,`tax`,`is_agent`,`type`,`terminology`,`payment_after_confirmation`,`menu_type`,`is_dine`) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    let reply1=await ExecuteQ.Query(dbName,sql,[order_instructions,cart_image_upload,name, supplierPlaceMentLevel, imageName, iconName, adminId,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation,menu_type,is_dine])
    //    let stmt =  multiConnection[dbName].query(sql, [order_instructions,cart_image_upload,name, supplierPlaceMentLevel, imageName, iconName, adminId,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation,menu_type],async function (err1, reply1) {
//     logger.debug("=================category query==========",stmt.sql)       
//         if (err1) {
//             console.log(err1);
//             sendResponse.somethingWentWrongError(res);
//         } else {
 ...
 */
async function updateCategory(dbName,order_instructions,cart_image_upload,res, callback, categoryId, name, imageName, iconName,agent_list,start_time,end_time, tax,is_agent,type,terminology,payment_after_confirmation,menu_type,is_dine) {
    try{
    var sql = "update categories set order_instructions=?,cart_image_upload=?,name = ?,image = ?,icon = ?,agent_list=?,start_time=?,end_time=?,tax=?,is_agent=?,type=?,terminology=?,payment_after_confirmation=?,menu_type=?,is_dine=? where id = ? ";
    await ExecuteQ.Query(dbName,sql,[order_instructions,cart_image_upload,name, imageName, iconName, agent_list, start_time, end_time,tax, is_agent,type,terminology,payment_after_confirmation,menu_type,is_dine,categoryId])
    // let stmt = multiConnection[dbName].query(sql, [order_instructions,cart_image_upload,name, imageName, iconName, agent_list, start_time, end_time,tax, is_agent,type,terminology,payment_after_confirmation,categoryId],async function (error, response) {
