...
var db_config = {
    ...
    // host:config.get('databaseSettings.cbl_host'),
    // user:config.get('databaseSettings.cbl_user'),
    // password:config.get('databaseSettings.cbl_password'),
    // database:config.get('databaseSettings.cbl_database'),
