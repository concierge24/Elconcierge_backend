...
exports.adminOrdersV2 =async function(dbName,res,limit,offset,serachText,
   ...
   let rating_given_filter_2 = "";
    if(parseInt(filter_by)!==0){
        if(parseInt(filter_by)==1){
            ...
            rating_given_filter_2= " join supplier_rating srt ON srt.order_id = o.id ";
        }
    }
        ...
        orders:async function (cb) {
            ...
            if(limit){
                ...
                if(tab_status==0){
                    ...
                    if(sub_status==1){
                        if(serachType==0){
                             sql="select o.is_dine_in,o.supplier_branch_id,o.table_id,o.table_id,o.wallet_discount_amount,o.created_on,o.zone_offset,o.delivered_on,o.is_payment_confirmed,dc.name as delivery_company_name,dc.id as delivery_company_id,o.user_service_charge,o.delivery_charges,o.handling_supplier,o.handling_admin,o.approve_rejection_reason,o.payment_status,s.is_own_delivery,o.type,o.tip_agent,o.user_service_charge,o.pres_description,o.pres_image1,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,o.payment_source,o.referral_amount,IFNULL(odp.discountAmount,0) as discountAmount,sb.address as branch_address,o.self_pickup,o.zelle_receipt_url,o.preparation_time,crt.area_id,sb.supplier_id,o.is_agent,o.payment_type,o.net_amount,o.id,o.created_on,o.schedule_date,s.name as supplier,o.status,u.email As User_Name,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,u.mobile_no " +
                                "from orders o join order_prices op on o.id = op.order_id join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id left  join cart crt on crt.id=o.cart_id "+
                    ...
                    if(sub_status==2){
                        ...
                        if(serachType==0){
                            ...
                            sqlCount="SELECT COUNT(DISTINCT o.id) as total_orders,o.is_dine_in, o.wallet_discount_amount, o.delivery_charges,o.delivered_on, o.handling_supplier, o.handling_admin, o.approve_rejection_reason, o.payment_status, o.type, o.tip_agent, o.user_service_charge, o.pres_description, o.pres_image1, o.pres_image2, o.pres_image3, o.pres_image4, o.pres_image5, o.payment_source, o.referral_amount, o.self_pickup, o.zelle_receipt_url, o.preparation_time, o.is_agent, o.payment_type, o.net_amount, o.id, o.created_on, o.schedule_date, o.status,o.supplier_branch_id,o.cart_id,o.user_id,o.user_delivery_address from orders o JOIN supplier_branch sb ON sb.id = o.supplier_branch_id JOIN supplier s ON sb.supplier_id = s.id LEFT JOIN cart crt ON crt.id = o.cart_id LEFT JOIN agent_orders ao ON ao.order_id = o.id JOIN user u ON o.user_id = u.id LEFT JOIN user_address ua ON ua.id = o.user_delivery_address LEFT JOIN order_promo odp ON odp.orderid = o.id  "+agent_assign_order_filter_2+" "+rating_given_filter_2+"  WHERE Date(o.created_on) >= '1991-01-11' AND Date(o.created_on) <= '2025-01-11' AND ( o.status = 8 OR o.status = 2 OR o.status = 5 OR o.status = 6 )"
    ...
    async.auto({
        orders:async function (cb) {
            ...
            if (tab_status == 0) {
                ...
                sql = 'select o.pres_description,o.pres_image1,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,o.pres_image2,o.pres_image3,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image4,ct.terminology,  o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                    'from orders o join order_prices op on op.order_id=o.id join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                    ...
                    sql = 'select o.pres_description,o.referral_amount,o.pres_image1,dc.name as delivery_company_name,dc.id as delivery_company_id,o.pres_image2,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image3,o.pres_image4,ct.terminology,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                    'from orders o  join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                    ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(0) '+payment_source_check+' and( u.lastname LIKE "%'+searchText+'%" or u.firstname LIKE "%'+searchText+'%" or u.email LIKE "%'+searchText+'%" or o.id LIKE "%'+searchText+'%")  group by o.id order by o.created_on DESC LIMIT ?,?';
                    
                }
            } else if (tab_status == 1) {
                if (subStatusNew) {
                    if(searchType==0){
                    sql = 'select o.pres_description,o.referral_amount,ct.terminology,o.pres_image1,dc.name as delivery_company_name,dc.id as delivery_company_id,o.pres_image2,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                        'from orders o join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                        ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(' + subStatusNew + ') '+payment_source_check+' group by o.id order by o.created_on DESC LIMIT ?,?';
                    
                    }
                    else{
                        sql = 'select o.pres_description,o.pres_image1,ct.terminology,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,o.net_amount,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                        'from orders o  join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                        ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(' + subStatusNew + ') '+payment_source_check+' and( u.lastname LIKE "%'+searchText+'%" or u.firstname LIKE "%'+searchText+'%" or u.email LIKE "%'+searchText+'%" or o.id LIKE "%'+searchText+'%") group by o.id order by o.created_on DESC LIMIT ?,?';
                        ...
                        if(searchType==0){
                         sql = 'select o.pres_description,o.pres_image1,ct.terminology,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                        'from orders o join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                        ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(1,3,7,9,10,11,4) '+payment_source_check+' group by o.id order by o.created_on DESC LIMIT ?,?';
                        }
                        else{
                            sql = 'select o.pres_description,o.pres_image1,ct.terminology,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                            'from orders o join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                ...
                if(subStatusNew){
                    ...
                    ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(' + subStatusNew + ') '+payment_source_check+' group by o.id order by o.created_on DESC LIMIT ?,?';
                        ...
                        sql = 'select o.pres_description,ct.terminology,o.pres_image1,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                        'from orders o join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                        ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(' + subStatusNew + ') '+payment_source_check+' and( u.lastname LIKE "%'+searchText+'%" or u.firstname LIKE "%'+searchText+'%" or u.email LIKE "%'+searchText+'%" or o.id LIKE "%'+searchText+'%") group by o.id order by o.created_on DESC LIMIT ?,?';
                    ...
                    if(searchType==0){
                            sql = 'select o.pres_description,ct.terminology,o.pres_image1,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,o.net_amount,payment_type,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                            'from orders o join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
                            ' left join delivery_companies dc on dc.id = o.delivery_company_id join user u on o.user_id=u.id left join user_address ua on ua.id=o.user_delivery_address left join order_promo odp on odp.orderId = o.id join product p on p.id=op.product_id join categories ct on ct.id=p.category_id where s.id= ? and DATE(o.created_on) >="'+start_date+'" and DATE(o.created_on)<="'+end_date+'" and o.payment_type='+payment_type+' and o.status IN(2,5,8) '+payment_source_check+' group by o.id order by o.id DESC LIMIT ?,?';
                    }
                    else{
                        sql = 'select o.pres_description,ct.terminology,o.pres_image1,o.referral_amount,dc.name as delivery_company_name,dc.id as delivery_company_id,IFNULL(odp.discountAmount,0) as discountAmount,o.pres_image2,o.pres_image3,o.pres_image4,o.pres_image5,sb.branch_name,sb.address as branch_address,o.preparation_time,o.self_pickup,o.status,crt.area_id,sb.supplier_id,o.is_agent,o.duration,o.promo_discount,o.type,o.promo_code,o.redeem_promo,o.apply_promo,o.id,o.created_on,o.schedule_date,o.net_amount,payment_type,ua.address_link,ua.customer_address,ua.latitude,ua.longitude,ua.landmark,ua.pincode,ua.address_line_1,ua.address_line_2,s.name as supplier,o.status,u.email As User_Name,u.mobile_no ' +
                        'from orders o join order_prices op on op.order_id=o.id  join supplier_branch sb on sb.id=op.supplier_branch_id join supplier s on sb.supplier_id=s.id join cart crt on crt.id=o.cart_id join cart_products  crtp on crt.id = crtp.cart_id ' +
            ...
            if(supplierBranchId){
               ...
               if ( orderApprovalByAdmin && orderApprovalByAdmin.length > 0)
                   sql = sqlSplit[0] + 's.id= ? and o.is_approved_by_admin=1 and crtp.supplier_branch_id='+supplierBranchId + sqlSplit[1];           

            } 

            if (!supplierBranchId && orderApprovalByAdmin && orderApprovalByAdmin.length > 0) {
                var sqlSplit = sql.split('s.id= ?');
                sql = sqlSplit[0] + 's.id= ? and o.is_approved_by_admin=1';           
             }
