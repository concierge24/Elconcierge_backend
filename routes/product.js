    ...
    async.waterfall([
            ...
            function (cb) {
                ...
                products.updateProduct(req.dbName,res, productId, names[0], priceUnit, descriptions[0], sku, barCode, commission,commissionType, 
                    ...
                    payment_after_confirmation,cart_image_upload,
                     ...
                     is_allergy_product,is_appointment,special_instructions,cb);
            ...
            //  console.log("..111..",languages);
             ...
             //   console.log("..111..",multiLanguageId);
                products.updateProductNameInMultiLanguage(req.dbName,res, names, descriptions, languages, measuringUnit, multiLanguageId, cb);
            },
            function (cb) {
                //console.log("..222..");
         ...
         /*   function (cb) {
            ...
            function (cb) {
                console.log("..333..");
                if(deleteOrder && deleteOrder.length){
                    products.deleteProductImagesOrder(req.dbName,res, productId,deleteOrder, cb);
                }else{
                    cb(null)
                }
            },
        ...
        /*    function (id, cb) {
             ...
             if(error){
                ...
                await updatePdfBranchProduct(recipe_pdf,data.productId,req.dbName);
                sendResponse.sendSuccessData(data,constant.responseMessage.SUCCESS, res, constant.responseStatus.SUCCESS);
             }
        }
    );
    ...
    // let cart_image_upload=req.body.cart_image_upload || 0
                insertProductBySupplierBranch(req.dbName,is_prescribed,res, branchId, categoryId, subCategoryId, detailedSubCategoryId, names[0], priceUnit, descriptions[0], sku, barCode,
                     commission, commissionType, commissionPackage, measuringUnit[0],pricing_type,
                      ...
                      is_subscription_required,allergy_description,
                      is_allergy_product,is_non_veg,is_appointment,special_instructions,cb);
...
exports.addPricingOfProductByAdmin = function (req, res) {
    ...
    logger.debug("===========req.body.deliveryCharges===========",req.body.deliveryCharges)
    ...
    var adminId;
    var actualPrice=0;
    //console.log(":kbjsdfuvjfd",req.body);
    if(consts.LOCATION_FLOW.flow==0){
        ...
        location_area_wise(res,req.dbName,accessToken, sectionId, productId, startDate, endDate, price, displayPrice, handlingFeeAdmin,
            ...
            offerType, type, id, pricing_type,manValues,adminId,actualPrice, function (err, data) {
                if (err) {
                    sendResponse.somethingWentWrongError(res);
                } else {
                    var data = []
...
var location_area_wise = function(
 ...
 handlingFeeSupplier,isUrgent,urgentPrice,urgentType,deliveryCharges,minOrder,chargesBelowMinOrder,areaId,
 offerType,type,id,pricing_type,manValues,adminId,actualPrice,callback   
){
    async.waterfall([
        function (cb) {
            func.checkBlank(res, manValues, cb);
        ...
        function (cb) {
            if (req.body.discountPrice) {
                ...
                if (req.body.houseCleaningPrice) {
                    var houseCleaningPrice = req.body.houseCleaningPrice;
                    insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, houseCleaningPrice, 0, discountPrice, discountStartDate, discountEndDate,pricing_type, cb);
                }
                else if (req.body.beautySaloonPrice) {
                    var beautySaloonPrice = req.body.beautySaloonPrice;
                    insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, 0, beautySaloonPrice, discountPrice, discountStartDate, discountEndDate,pricing_type, cb);
                }
                else {
                    insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, 0, 0, discountPrice, discountStartDate, discountEndDate,pricing_type, cb);
                }
                ...
                if (req.body.houseCleaningPrice) {
                    var houseCleaningPrice = req.body.houseCleaningPrice;
                    insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, houseCleaningPrice, 0, 0, 0, 0,pricing_type, cb);
                }
                else if (req.body.beautySaloonPrice) {
                    var beautySaloonPrice = req.body.beautySaloonPrice;
                    insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, 0, beautySaloonPrice, 0, 0, 0,pricing_type, cb);
                }
                else {
                    insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, 0, 0, 0, 0, 0,pricing_type, cb);
                }
            }
        },
    ], function (error, result) {
...
accessToken,sectionId,productId,startDate,endDate,price,displayPrice,handlingFeeAdmin,
handlingFeeSupplier,isUrgent,urgentPrice,urgentType,deliveryCharges,minOrder,chargesBelowMinOrder,
offerType,type,id,pricing_type,manValues,adminId,actualPrice,discountPrice,discountStartDate,discountEndDate,houseCleaningPrice,beautySaloonPrice,callback
){
    async.waterfall([
        function (cb) {
            func.checkBlank(res, manValues, cb);
...
var insertProductPrice = async function(dbName,res,productId,startDate,endDate,price,handlingFeeAdmin,handlingFeeSupplier, isUrgent,urgentPrice,deliveryCharges,minOrder, chargesBelowMinOrder, urgentType, offerType,type,id,displayPrice,discountPrice,discountStartDate,discountEndDate,pricing_type,houseCleaningPrice,beautySaloonPrice,callback){
    try{
    logger.debug("==========start date====end date=====price===previous===>>>>",startDate,endDate,price,discountPrice)
    ...
    if(discountPrice===0 || discountPrice===undefined || discountPrice==="" || discountPrice===null){
        ...
        //     else {
                if(result.length){
                    ...
                    var sql1 = "insert into product_pricing(product_id,start_date,end_date,price,handling,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
                    await ExecuteQ.Query(dbName,sql1,[productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, offerType, displayPrice,urgentPrice,pricing_type])
                    // multiConnection[dbName].query(sql1, [productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, offerType, displayPrice,urgentPrice,pricing_type], function (err, result) {
                    //     if (err) {
    ...
    //    var stmt = multiConnection[dbName].query(sql1, [productId, 0, 0], function (err, result) {
    //         if (err) {
    ...
    //         else {
                if (result.length) {
                    ...
                    // var stmt = multiConnection[dbName].query(sql1, [productId, 0, 1], function (err, check) {
                    //     if (err) {
                    ...
                    //     else {
                            if (check.length) {
                                ...
                                var sql22 = "insert into product_pricing(product_id,start_date,end_date,price,handling,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,house_cleaning_price,beauty_saloon_price,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
                                await ExecuteQ.Query(dbName,sql22,[productId, discountStartDate, discountEndDate, discountPrice, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 1, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type])
                                //    var stmt =  multiConnection[dbName].query(sql22, [productId, discountStartDate, discountEndDate, discountPrice, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 1, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                            //         if (err) {
                            //             console.log(err)
                            ...
                            //         else {
                                        if (type == 0) {
                                            ...
                                            var sql2 = "update supplier_product set delivery_charges = ? where product_id = ? and supplier_id = ?"
                                            await ExecuteQ.Query(dbName,sql2,[deliveryCharges, productId, id])
                                            // var stmt = multiConnection[dbName].query(sql2, [deliveryCharges, productId, id], function (err, result) {
                                            //     if (err) {
                    ...
                    // var stmt = multiConnection[dbName].query(sql, [productId, 0, 1], function (err, check) {
                    //     if (err) {
                    ...
                    //     }
                        // else {
                            if (check.length) {
                                var sql11 = "insert into product_pricing(product_id,start_date,end_date,price,handling,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,house_cleaning_price,beauty_saloon_price,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                                await ExecuteQ.Query(dbName,sql11,[productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 0, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type])
                                // var stmt = multiConnection[dbName].query(sql11, [productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 0, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                                //     if (err) {
                                //         // console.log(err);
                                ...
                                var sql22 = "insert into product_pricing(product_id,start_date,end_date,price,handling,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,house_cleaning_price,beauty_saloon_price,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                                await ExecuteQ.Query(dbName,sql22,[productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 0, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type])
                                // var stmt = multiConnection[dbName].query(sql22, [productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 0, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                                //     if (err) {
                                //         // console.log(err);
                                ...
                                //     }
                                //     else {
                                        var sql33 = "insert into product_pricing(product_id,start_date,end_date,price,handling,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,house_cleaning_price,beauty_saloon_price,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                                        await ExecuteQ.Query(dbName,sql33,[productId, discountStartDate, discountEndDate, discountPrice, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 1, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type])
                                        // var stmt = multiConnection[dbName].query(sql33, [productId, discountStartDate, discountEndDate, discountPrice, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 1, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                                        //     if (err) {
                                        //         // console.log(err)
        ...
        if(discountPrice===0 || discountPrice===undefined || discountPrice==="" || discountPrice===null){
            ...
            //     else {
                    if(result.length){
                        ...
                        await ExecuteQ.Query(dbName,sql1,[productId, startDate, endDate, price,handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges,urgentType, offerType, displayPrice,urgentPrice,pricing_type,user_type_id])
                        ...
                        //     else {
                                if (check.length) {
                                   ...
                                   await ExecuteQ.Query(dbName,sql11,[
                                    ...
                                    beautySaloonPrice, displayPrice,urgentPrice,pricing_type,user_type_id
                                   ])
                        ...
                        for(const [index,i] of price.entries()){
                            await editPricingNew(req.dbName,res,i.productPricingId, i.startDate, i.endDate, 
                                ...
                                deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType,
                                 i.offerType, type, id, i.displayPrice, houseCleaningPrice, 0,productId,i.user_type_id);  
                        }           
                    cb(null);
                    }else{
                        if (req.body.houseCleaningPrice) {
                            ...
                            editPricing(req.dbName,res,productPricingId, startDate, endDate, 
                                ...
                                deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType,
                                 offerType, type, id, displayPrice, houseCleaningPrice, 0,productId,cb);
                        }
                        else if (req.body.beautySaloonPrice) {
                            var beautySaloonPrice = req.body.beautySaloonPrice;
                            editPricing(req.dbName,res, productPricingId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, 0, beautySaloonPrice,productId,cb);
                        }
                        else {
                            editPricing(req.dbName,res, productPricingId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, 0, 0,productId,cb);
                        }
                    }
...
async function insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, houseCleaningPrice, beautySaloonPrice, discountPrice, discountStartDate, discountEndDate,pricing_type, callback) {
try{
    if (discountPrice == 0) {
        var sql = "select id from product_pricing where product_id = ? and price_type = ? and is_deleted = ? limit 1";
        let result=await ExecuteQ.Query(dbName,sql,[productId, 0, 0])
        // var stmt = multiConnection[dbName].query(sql, [productId, 0, 0], function (err, result) {
            
        //     //console.log("1",err,result);
        //     if (err) {
        //         logger.debug("=============in insert pricing=======error=======1=======",stmt.sql,err)
        //         sendResponse.somethingWentWrongError(res);
        //     }
            // else {
                /*if (result.length) {
             ...
             //   else {
                if(result.length){
                    var sql11='update product_pricing set is_deleted =1 where product_id = ? and price_type= ?'
                    await ExecuteQ.Query(dbName,sql11,[productId,0]);
                //    var stmt = multiConnection[dbName].query(sql11,[productId,0],function (err,result) {
                //         if(err){
                //             console.log("update",err);
                //             logger.debug("=============in insert pricing=======error=======2=======",stmt.sql,err)

                //             sendResponse.somethingWentWrongError(res);
                //         }
                //     })
                }
                    //console.log("1",productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, offerType, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type);
                    var sql1 = "insert into product_pricing(product_id,start_date,end_date,price,handling,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,house_cleaning_price,beauty_saloon_price,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
                    await ExecuteQ.Query(dbName,sql1,[productId, moment(startDate).format('YYYY-MM-DD'), moment(endDate).format('YYYY-MM-DD'), price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, offerType, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type])
                    // var stmt =  multiConnection[dbName].query(sql1, [productId, moment(startDate).format('YYYY-MM-DD'), moment(endDate).format('YYYY-MM-DD'), price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, offerType, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                        // if (err) {
                        //     logger.debug("=============in insert pricing=======error====3==========",err)
                        ...
                        // else {
                            if (type == 0) {
                                ...
                                // var stmt = multiConnection[dbName].query(sql2, [deliveryCharges, productId, id], function (err, result) {
                                //     if (err) {
                                //         logger.debug("=============in insert pricing=======error======4========",stmt.sql,err)
                                ...
                                // var stmt = multiConnection[dbName].query(sql3, [id, productId], function (err, result5) {
                                //     if (err) {
                                //         logger.debug("=============in insert pricing=======error=======5=======",stmt.sql,err)
                                            ...
                                            (async function (i) {
                                                ...
                                                if (i == areaId.length - 1) {
                                                   ...
                                                   await ExecuteQ.Query(dbName,sql4,values);
                                                    // var stmt = multiConnection[dbName].query(sql4, values, function (err, result) {
                                                    //     if (err) {
                                                    //         logger.debug("=============in insert pricing=======error=====6=========",stmt.sql,err)
                    ...
                    //     else {
                            ...
                            //         else {
                                        if (type == 0) {
                                            ...
                                            // var stmt = multiConnection[dbName].query(sql3, [id, productId], function (err, result5) {
                                            //     if (err) {
                                            //         logger.debug("=============in insert pricing=======error========11======",stmt.sql,err)
                                                    ...
                                                    for (var i = 0; i < areaId.length; i++) {
                                                        (async function (i) {
                                                            ...
                                                            if (i == areaId.length - 1) {
                                                                ...
                                                                // var stmt = multiConnection[dbName].query(sql4, values, function (err, result) {
                                                                //     if (err) {
                                                                //         logger.debug("=============in insert pricing=======error=======12=======",stmt.sql,err)
                            ...
                            if (check.length) {
                                ...
                                //     else {
                                        ...
                                        //     else {
                                                ...
                                                //    var stmt = multiConnection[dbName].query(sql3, [id, productId], function (err, result5) {
                                                //         if (err) {
                                                //             logger.debug("=============in insert pricing=======error======18========",stmt.sql,err)
                                                            ...
                                                            for (var i = 0; i < areaId.length; i++) {
                                                                (async function (i) {
                                                                    ...
                                                                    if (i == areaId.length - 1) {
                                                                        ...
                                                                        // var stmt = multiConnection[dbName].query(sql4, values, function (err, result) {
                                                                        //     if (err) {
                                                                        //         logger.debug("=============in insert pricing=======error=======19=======",stmt.sql,err)
...
async function  editPricing(dbName,res,productPricingId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, type, id, displayPrice, houseCleaningPrice,beautySaloonPrice,productId,callback)
{
    ...
    if(offerType == 1)
    {
        ...
        //     else{
                if(check.length){
                    ...
                    await ExecuteQ.Query(dbName,sql,[moment(startDate).format('YYYY-MM-DD'),moment(endDate).format('YYYY-MM-DD'),price,handlingFeeAdmin,handlingFeeSupplier,isUrgent,urgentPrice,houseCleaningPrice,beautySaloonPrice,offerType,urgentType,urgentPrice,deliveryCharges,productPricingId])
...
exports.updateProduct=async function(dbName,res, productId, names, priceUnit, 
    ...
    is_subscription_required,allergy_description,
    is_allergy_product,is_appointment,special_instructions, callback) {
   try{
      ...
      is_product,pricing_type,duration,payment_after_confirmation,cart_image_upload)
        // let priceAndDurationDetails =   await  getProductPriceDurationDetails(dbName,productId);
    let results = await ExecuteQ.Query(dbName,"select app_type from screen_flow",[]);
    // if((priceAndDurationDetails[0].pricing_type!==pricing_type || priceAndDurationDetails[0].duration!==duration) && results[0].app_type==8){
    //     await removeProductPricing(dbName,productId)
    // }

    var sql = "update product set payment_after_confirmation = ?,cart_image_upload = ?,name = ?,price_unit = ?,product_desc = ?,sku = ?,bar_code = ?,commission = ?,  ";
    sql += " commission_type = ?,commission_package = ? ,measuring_unit= ?,quantity = ?,brand_id=?,is_product=?,pricing_type=?,duration=?, making_price=?,product_tags=?,Size_chart_url=?,country_of_origin=?,purchase_limit=?,is_subscription_required=?,allergy_description=?,is_allergy_product=?,is_appointment=?,special_instructions=? where id = ? limit 1";
    ...
    await ExecuteQ.Query(dbName,sql,[payment_after_confirmation,
        cart_image_upload,names,
         priceUnit, descriptions, sku, barCode, commission,
          ...
          special_instructions,productId])
    // var stmt = multiConnection[dbName].query(sql, [payment_after_confirmation,cart_image_upload,names, priceUnit, descriptions, sku, barCode, commission, commissionType, commissionPackage, measuringUnit,quantity,brand_id,is_product,pricing_type,duration,productId], function (err, result) {
    //     logger.debug("==========in the update product =======111111=====",stmt.sql,err)
    //     if (err) {
    //         logger.debug("==========in the update product ============",stmt.sql,err)
    //         sendResponse.somethingWentWrongError(res)
    //     }
    //     else {
            callback(null);
...
exports.updateProductNameInMultiLanguage = function(dbName,res, names, descriptions, languages, measuringUnit, multiLanguageId, callback) {
    ...
    console.log(".update proudct id ............................",names[i], descriptions[i], measuringUnit[i], multiLanguageId[i]);
    ...
    for (var i = 0; i < languageLength; i++) {
        (async function (i) {
            ...
            // multiConnection[dbName].query(sql,[names[i], descriptions[i], measuringUnit[i], multiLanguageId[i]], function (err, result) {
            //     console.log("......err...multi name....fbvgdfbgfrhnfgjnhg.",err,result);
            //     if(err) 
            //         {
            //             callback(err);
            //         } else 
...
exports.deleteProductImagesOrder=function(dbName,res,productId,order,callback){
        ...
        (async function (i) {
            async.auto({
                productOrder:async function(cb){
                    ...
                    // multiConnection[dbName].query(sql, [productId,order[i]], function (err, result) {
                    //     console.log(".............err..................",err,result);
                    //     if (err) {
                    //         sendResponse.somethingWentWrongError(res)
                    //     }
                ...
                defaultOrder:async function(cb){
                    ...
                    // multiConnection[dbName].query(sql, [productId,1], function (err, result) {
                    //     console.log(".............err..................",err,result);
                    //     if (err) {
                    //         sendResponse.somethingWentWrongError(res)
                    //     }
...
exports.listSupplierBranchProductsV1= function(dbName,res, branchId, categoryId, subCategoryId, detailedSubCategoryId,limit,offset,serachType,serachText, tags,callback) {
    ...
    async.auto({
        ...
        productVariant:["productImage",async function (cb) {
            var len = data1.length;
            if(data1.length){
                // var len = productIds.length;
                ...
                var productIds = [];
                for(var i =0;i < len;i++){
                    productIds.push(data1[i].id);
                    data1[i].variant = [];
                }
                var vsql = "select variants.id as vaiant_id,variants.value,product_variants.product_id,product_variants.id from product_variants inner join variants on variants.id=product_variants.variant_id where product_variants.product_id IN (?)";
                let vData=await ExecuteQ.Query(dbName,vsql,[productIds]);
                if (vData && vData.length) {
                    for (const [index, i] of vData.entries()) {
                        for(var j =0;j < len;j++){
                            if (i.product_id = data1[j].id) {
                                data1[j].variant = i;
                            }
                        }
                    }
...
async function listSupplierBranchProductDetails(dbName,res, branchId, categoryId, subCategoryId, detailedSubCategoryId,limit,offset,serachType,serachText, callback) {
   try{
    ...
    if(serachType==0){
        var sql = "select "+tblSettingSql+"p.quantity,IF((select count(*) from product where product.parent_id=p.id and product.is_deleted=0)>0,1,0) as is_variant,p.is_appointment,p.pricing_type,(p.quantity-p.purchased_quantity) as left_quantity,p.purchased_quantity,p.special_instructions,br.id as brand_id,br.name as brand_name,br.image as brand_image,p.name,p.id,p.is_product,p.duration,p.bar_code,p.product_desc,p.making_price,p.sku,p.is_live,p.commission,p.measuring_unit,p.commission_type,p.commission_package,p.category_id,p.sub_category_id,p.detailed_sub_category_id,c.chemical_tools_price_applicable,c.services_at_home_price_applicable,c.name category_name,c.is_barcode,curr.currency_name from supplier_branch_product sp ";
        sql += " join product p on sp.product_id = p.id left join brands br on br.id=p.brand_id join categories c on c.id = p.category_id join currency_conversion curr ";
        ...
        var sql = "select "+tblSettingSql+"p.quantity,IF((select count(*) from product where product.parent_id=p.id)>0,1,0) as is_variant,p.pricing_type,(p.quantity-p.purchased_quantity) as left_quantity,p.is_appointment,p.purchased_quantity,br.id as brand_id,br.name as brand_name,p.measuring_unit,p.special_instructions,br.image as brand_image,p.name,p.id,p.is_product,p.duration,p.bar_code,p.product_desc,p.sku,p.is_live,p.making_price,p.commission,p.commission_type,p.commission_package,p.category_id,p.sub_category_id,p.detailed_sub_category_id,c.chemical_tools_price_applicable,c.services_at_home_price_applicable,c.name category_name,c.is_barcode,curr.currency_name from supplier_branch_product sp ";
        sql += " join product p on sp.product_id = p.id left join brands br on br.id=p.brand_id join categories c on c.id = p.category_id join currency_conversion curr ";
...
async function listSupplierBranchProductDetailsV1(dbName,res, branchId, categoryId, subCategoryId, detailedSubCategoryId,limit,offset,serachType,serachText,tags, callback) {
    ...
    var id =[];
     ...
     if(serachType==0){
         var sql = "select "+tblSettingSql+"sp.recipe_pdf,p.measuring_unit,p.special_instructions,p.is_supplier_product_approved,p.is_appointment,p.is_non_veg,p.purchase_limit,p.allergy_description,p.is_allergy_product,p.is_subscription_required,p.country_of_origin,p.Size_chart_url,p.item_unavailable,p.payment_after_confirmation,p.cart_image_upload,IF((select count(*) from product where product.parent_id=p.id and product.is_deleted=0)>0,1,0) as is_variant,c.type,(p.quantity-p.purchased_quantity) as left_quantity,p.is_prescribed,p.interval_flag,p.interval_value, p.making_price,p.product_tags,p.quantity,p.purchased_quantity,br.id as brand_id,br.name as brand_name,br.image as brand_image,p.pricing_type,p.name,p.id,p.is_product,p.duration,p.bar_code,p.product_desc,p.sku,p.is_live,p.commission,p.commission_type,p.commission_package,p.category_id,p.sub_category_id,p.detailed_sub_category_id,c.chemical_tools_price_applicable,c.services_at_home_price_applicable,c.name category_name,c.is_barcode,curr.currency_name,sp.order_no from supplier_branch_product sp ";
         sql += " join product p on sp.product_id = p.id left join brands br on br.id=p.brand_id and br.deleted_by= 0 join categories c on c.id = p.category_id left join currency_conversion curr ";
         sql += " on curr.id = p.price_unit where p.parent_id=? and sp.supplier_branch_id = ? and sp.is_deleted = ? and sp.category_id = ? and sp.sub_category_id = ?  and sp.detailed_sub_category_id = ?  "+qr+" order by sp.order_no limit ?,?";
 
     }
     else {
        var sql = "select sp.recipe_pdf,p.measuring_unit,p.Size_chart_url,p.special_instructions,p.is_supplier_product_approved,p.is_appointment,p.is_non_veg,p.purchase_limit,p.allergy_description,p.is_allergy_product,p.is_subscription_required,p.country_of_origin,p.payment_after_confirmation,p.item_unavailable,p.cart_image_upload,IF((select count(*) from product where product.parent_id=p.id)>0,1,0) as is_variant,(p.quantity-p.purchased_quantity) as left_quantity,c.type,p.interval_flag,p.interval_value, p.making_price,p.product_tags,p.is_prescribed,p.quantity,p.purchased_quantity,br.id as brand_id,br.name as brand_name,br.image as brand_image,p.name,p.id,p.pricing_type,p.is_product,p.duration,p.bar_code,p.product_desc,p.sku,p.is_live,p.commission,p.commission_type,p.commission_package,p.category_id,p.sub_category_id,p.detailed_sub_category_id,c.chemical_tools_price_applicable,c.services_at_home_price_applicable,c.name category_name,c.is_barcode,curr.currency_name,sp.order_no from supplier_branch_product sp ";
         sql += " join product p on sp.product_id = p.id left join brands br on br.id=p.brand_id and br.deleted_by= 0 join categories c on c.id = p.category_id left join currency_conversion curr ";
         sql += " on curr.id = p.price_unit where p.parent_id=? and sp.supplier_branch_id = ? and sp.is_deleted = ?   and sp.category_id = ? and sp.sub_category_id = ? and sp.detailed_sub_category_id = ? " +
             "and (p.id LIKE '%"+serachText+"%' or p.bar_code LIKE '%"+serachText+"%' or p.name LIKE '%"+serachText+"%'" +
             " or p.sku LIKE '%"+serachText+"%' or p.product_desc LIKE '%"+serachText+"%' or c.name LIKE '%"+serachText+"%'  or c.name LIKE '%"+serachText+"%') "+qr+" ORDER BY sp.order_no,p.id DESC LIMIT ?,?";
...
async function insertProductBySupplierBranch(dbName,is_prescribed,res, branchId, categoryId, subCategoryId, detailedSubCategoryId, name, priceUnit, description, sku, barCode, commission, commissionType, commissionPackage, measuringUnit,
    ...
    is_non_veg,is_appointment,special_instructions,callback) {
    ...
    if(api_version==1){
        ...
        params=[country_of_origin,Size_chart_url,
            ...
            sku, detailedSubCategoryId, 0, branchId, 2, commission,
             ...
             is_subscription_required,allergy_description,
             is_allergy_product,is_non_veg,is_appointment,special_instructions]
    }
    let result=await ExecuteQ.Query(dbName,sql,params);
    console.log("--Exit--")
    callback(null, result.insertId);
...
async function listSupplierCategoriesV1(dbName,res, supplierId,language_id, callback) {
    try{
        ...
        // sql += " on s.category_id = c.id join supplier ss on ss.id  = s.supplier_id where s.supplier_id = ? and c.parent_id = 0 and c.is_live=1 group by s.category_id";
            ...
            var sql = "select ss.commisionButton ,ss.urgentButton,c.id as category_id,c.type,c.is_variant, cml.name,s.commission_type,s.commission,s.commission_package,c.is_barcode,c.order,c.product_addition_level,c.tax from supplier_category s join categories c";
...
async function deleteSupplierProductOfBranch(dbName,res, productId, branchId, callback) {
  try{
    ...
    //     }
    //     else {
            var sql3 = "delete from supplier_branch_area_product where  supplier_branch_id = ? and product_id IN ("+productId+")";
