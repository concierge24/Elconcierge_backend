...
console.log("======manValue===========",manValue)
   async.waterfall([
       ...
       function (name, cb) {
           ...
           savecategory(req.dbName,order_instructions,cart_image_upload,res, cb, names[0], imageName, iconName, adminId, supplierPlaceMentLevel,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation)
 ...
 *  into category table.
 */
async function savecategory(dbName,order_instructions,cart_image_upload,res, callback, name, imageName, iconName, adminId, supplierPlaceMentLevel,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation) {
   try{
    var sql = "insert into categories(`order_instructions`,`cart_image_upload`,`name`, `supplier_placement_level`,  `image`, `icon`,`created_by`,`is_variant`,`category_flow`,`agent_list`,`start_time`,`end_time`,`tax`,`is_agent`,`type`,`terminology`,`payment_after_confirmation`) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    let reply1=await ExecuteQ.Query(dbName,sql,[order_instructions,cart_image_upload,name, supplierPlaceMentLevel, imageName, iconName, adminId,is_variant,category_flow,agent_list,start_time,end_time,tax,is_agent,type,terminology,payment_after_confirmation])
   ...
   // console.log("==================image===========" + JSON.stringify(image));
    ...
    async.waterfall([
        ...
        function (name1, cb) {
            ...
            iconName = name1;
            updateCategory(req.dbName,order_instructions,cart_image_upload,res, cb, categoryId, names[0], imageName, iconName,agent_list,start_time,end_time, tax,type,terminology,payment_after_confirmation);
        },
        function (cb) {
...
async function updateCategory(dbName,order_instructions,cart_image_upload,res, callback, categoryId, name, imageName, iconName,agent_list,start_time,end_time, tax,type,terminology,payment_after_confirmation) {
    try{
    var sql = "update categories set order_instructions=?,cart_image_upload=?,name = ?,image = ?,icon = ?,agent_list=?,start_time=?,end_time=?,tax=?,type=?,terminology=?,payment_after_confirmation=? where id = ? ";
        await ExecuteQ.Query(dbName,sql,[order_instructions,cart_image_upload,name, imageName, iconName, agent_list, start_time, end_time, tax,type,terminology,payment_after_confirmation,categoryId])
