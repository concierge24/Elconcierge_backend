    ...
    async.auto({
        ...
        insertProduct:['supplierId',function (cb) {
            ...
            insertProduct(req.dbName,is_prescribed,res, supplierId, categoryId, subCategoryId, detailedSubCategoryId, names[0],
                ...
                quantity,parent_id,brand_id,is_product,duration,interval_flag,interval_value,api_version,is_driver,cart_image_upload,payment_after_confirmation,function (err,result) {
                if(err){
                ...
                if (checkUserType && checkUserType.length > 0) {
                    ...
                    if (req.body.discountPrice) {
                        ...
                        if (req.body.houseCleaningPrice) {
                            ...
                            insertPricing(req.dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, displayPrice, houseCleaningPrice, 0, discountPrice, discountStartDate, discountEndDate,pricing_type, cb);
                        }
                            ...
                            insertPricing(req.dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType,  displayPrice, 0, beautySaloonPrice, discountPrice, discountStartDate, discountEndDate,pricing_type, cb);
                        }
                        else {
                            console.log("=============3=====================",discountStartDate,discountEndDate)
                            insertPricing(req.dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType,  displayPrice, 0, 0, discountPrice, discountStartDate, discountEndDate,pricing_type, cb);
                        }
                        ...
                        if (req.body.houseCleaningPrice) {
                            var houseCleaningPrice = req.body.houseCleaningPrice;
                            insertPricing(req.dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, displayPrice, houseCleaningPrice, 0, 0, 0, 0,pricing_type, cb);
                        }
                        else if (req.body.beautySaloonPrice) {
                            var beautySaloonPrice = req.body.beautySaloonPrice;
                            insertPricing(req.dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, displayPrice, 0, beautySaloonPrice, 0, 0, 0,pricing_type, cb);
                        }
                        else {
                            insertPricing(req.dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, displayPrice, 0, 0, 0, 0, 0,pricing_type, cb);
                        }
                    }
                }
        },
...
exports.addSupplierBranchProduct = function (req, res) {
    ...
    var commissionPackage = req.body.commissionPackage;
    console.log('========sttastat========',branchId)
    let cart_image_upload=req.body.cart_image_upload || 0;
    let payment_after_confirmation=req.body.payment_after_confirmation || 0;
    var manValues = [accessToken, sectionId, measuringUnit, branchId, categoryId, subCategoryId, detailedSubCategoryId, name, languageId, priceUnit, description, sku, commission, commissionType, commissionPackage, count];
    var folder = "abc";
    var names;
    var languages;
    var descriptions;
                      ...
                      detailedSubCategoryId, names[0], priceUnit,
                       descriptions[0], sku, barCode, commission,
                        commissionType, commissionPackage,
                         ...
                         item_unavailable,is_non_veg,is_appointment,cb);
            },
            async function (id, cb) {
                productId = id;
...
function insertProduct(dbName,is_prescribed,res, adminId, categoryId, subCategoryId, detailedSubCategoryId, name, priceUnit, description, sku, barCode,unit, commission, commissionType, commissionPackage,pricing_type,quantity,parent_id,brand_id,is_product,duration,interval_flag,interval_value,api_version,is_driver,cart_image_upload,payment_after_confirmation,callback) {


    var sql = "insert into product(cart_image_upload,payment_after_confirmation,is_prescribed,name,price_unit,bar_code,product_desc,sku,measuring_unit,category_id,sub_category_id,detailed_sub_category_id,is_global,added_by,created_by,commission,commission_type,commission_package,pricing_type,is_live,quantity,parent_id,brand_id,is_product,duration) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
    var params=[cart_image_upload,payment_after_confirmation,is_prescribed,name, priceUnit, barCode, description, sku,unit,categoryId, subCategoryId, detailedSubCategoryId, 0,1, adminId, commission, commissionType, commissionPackage,pricing_type,1,quantity,parent_id,brand_id,is_product,duration]
    
    if(api_version>=1){
         sql = "insert into product(cart_image_upload,payment_after_confirmation,is_prescribed,name,price_unit,bar_code,product_desc,sku,measuring_unit,category_id,sub_category_id,detailed_sub_category_id,is_global,added_by,created_by,commission,commission_type,commission_package,pricing_type,is_live,quantity,parent_id,brand_id,is_product,duration,interval_flag,interval_value) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
         params=[cart_image_upload,payment_after_confirmation,is_prescribed,name, priceUnit, barCode, description, sku,unit,categoryId, subCategoryId, detailedSubCategoryId, 0,1, adminId, commission, commissionType, commissionPackage,pricing_type,1,quantity,parent_id,brand_id,is_product,duration,interval_flag,interval_value]
...
async function insertProductBySupplierBranch(dbName,res, branchId,
     categoryId, subCategoryId, detailedSubCategoryId, name, priceUnit,
      description, sku, barCode, commission, commissionType,
       ...
       is_driver,cart_image_upload,
       payment_after_confirmation,
       item_unavailable,is_non_veg,is_appointment,callback) {
try{
    var sql = "insert into product(cart_image_upload,payment_after_confirmation,pricing_type,is_live,name,price_unit,bar_code,product_desc,sku,category_id,is_global,created_by,added_by,commission,commission_type,commission_package,measuring_unit,quantity,parent_id,brand_id,is_product,duration,is_non_veg) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
    var params=[cart_image_upload,payment_after_confirmation,pricing_type,1,name, priceUnit, barCode, description, sku, detailedSubCategoryId, 0, branchId, 2, commission, commissionType, commissionPackage, measuringUnit,quantity,parent_id,brand_id,is_product,duration,is_non_veg];
    ...
    if(api_version>=1){
         sql = `insert into product(
            ...
            payment_after_confirmation,
             ...
             interval_value,
             item_unavailable,
             is_non_veg,is_appointment) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`
         params=[
            cart_image_upload,
            payment_after_confirmation,
            pricing_type,
...
function insertPricing(dbName,res, productId, startDate, endDate, price, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType, displayPrice, houseCleaningPrice, beautySaloonPrice, discountPrice, discountStartDate, discountEndDate,pricing_type, callback) {
    {
        ...
        if (discountPrice == 0) {
            ...
            multiConnection[dbName].query(sql, [productId, 0, 0], function (err, result) {
                if (err) {
                    ...
                    var sql1 = "insert into product_pricing(product_id,start_date,end_date,price,handling_supplier,can_urgent,urgent_price,delivery_charges,urgent_type,price_type,house_cleaning_price,beauty_saloon_price,display_price,urgent_value,pricing_type) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
       ...
       /*     var sql1 = "select id from product_pricing where product_id = ? and price_type = ? and is_deleted = ? limit 1";
            multiConnection[dbName].query(sql1, [productId, 1, 0], function (err, result) {
                if (err) {
                    sendResponse.somethingWentWrongError(res);
                }
                else {
                    if (result.length) {
                        ...
                        multiConnection[dbName].query(sql, [productId, 0, 1], function (err, check) {
                            if (err) {
                                sendResponse.somethingWentWrongError(res)
                            }
                            else {
                                if (check.length) {
                                    ...
                                    multiConnection[dbName].query(sql11, [productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 0, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                                        if (err) {
                                            console.log(err);
                                            sendResponse.somethingWentWrongError(res);
                                        }
                                    ...
                                    multiConnection[dbName].query(sql22, [productId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 0, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                                        if (err) {
                                            console.log(err);
                                            sendResponse.somethingWentWrongError(res);
                                        }
                                            ...
                                            multiConnection[dbName].query(sql33, [productId, discountStartDate, discountEndDate, discountPrice, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, urgentType, 1, houseCleaningPrice, beautySaloonPrice, displayPrice,urgentPrice,pricing_type], function (err, result) {
                                                if (err) {
                                                    console.log(err)
                                                    sendResponse.somethingWentWrongError(res);
                                                }
...
exports.editProduct = async function (req, res) {
   ...
   console.log("****************************",req.body)
    ...
    var is_product=req.body.is_product!=undefined && req.body.is_product!="" && req.body.is_product!=null?req.body.is_product:1
        ...
        function (cb) {
            ...
            function (cb) {
               ...
               products.updateProduct(req.dbName,res, productId, names[0], priceUnit, descriptions[0], sku, barCode,
                 ...
                 is_subscription_required,allergy_description,is_allergy_product,is_appointment,cb);
            },
            function (cb) {
...
exports.editPricing = function (req, res) {
    ...
    var id=req.body.id;
    // {"accessToken":"1c73ed3313cf76f250d6fe93c94c4364b391c3775ac2cd2f9bcb79bd0297504b7cb622a357fe986373db6346087c5f72bae9c0370928d9fc1f5a9ecce029975569ed4c3f1115dddc27d592979a7b0dd5",
    // "sectionId":30,"productId":104,"startDate":"2000-01-01","endDate":"2099-01-01","price":1000,
    // "displayPrice":1000,"handlingFeeAdmin":9,"handlingFeeSupplier":0,"isUrgent":0,"urgentPrice":0,
    // "commission":0,"deliveryCharges":10,"urgentType":0,"commissionType":0,
    // "houseCleaningPrice":0,"beautySaloonPrice":0,"offerType":0,"type":0,"minOrder":0,
    // "chargesBelowMinOrder":0,
    // "areaId":0,"id":"56","pricing_type":0}
        ...
        function (cb) {
           ...
           async function (cb) {
                ...
                if(checkUserType && checkUserType.length>0){
                    ...
                    if (req.body.houseCleaningPrice) {
                        var houseCleaningPrice = req.body.houseCleaningPrice;
                        editPricing(req.dbName,res,productPricingId, startDate, endDate, price, handlingFeeAdmin, handlingFeeSupplier, isUrgent, urgentPrice, deliveryCharges, minOrder, chargesBelowMinOrder, areaId, urgentType, offerType,type , id, displayPrice, houseCleaningPrice, 0,productId,cb);
                    }
                    else if (req.body.beautySaloonPrice) {
                        var beautySaloonPrice = req.body.beautySaloonPrice;
